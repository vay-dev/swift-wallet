...
class Device(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='device')
    device_id = models.CharField(max_length=255, unique=True)
    device_name = models.CharField(max_length=255, blank=True, help_text="Browser/Device info")
...
class FaceVerification(models.Model):
    ...
    clarity_score = models.FloatField(null=True, blank=True, help_text="Image clarity score 0-100")
    lighting_score = models.FloatField(null=True, blank=True, help_text="Lighting quality score 0-100")
...
class DeviceChangeLog(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='device_changes')
...
class AccountNumberChangeLog(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='account_number_changes')
