...
from .utils import get_client_ip, generate_and_save_otp, send_device_change_notification
import logging
        ...
        if serializer.is_valid():
            ...
            return Response({
                ...
                'data': {
                    ...
                    'otp_code': otp.otp_code,  # For demo purposes only
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                otp = generate_and_save_otp(phone_number, otp_type='device_change')

                return Response({
                    'status': 'success',
                    'message': 'OTP sent for device change verification',
                    'data': {
                        'phone_number': phone_number,
                        'otp_code': otp.otp_code,  # For demo purposes
                        'expires_in': '5 minutes'
                    }
                }, status=status.HTTP_200_OK)
